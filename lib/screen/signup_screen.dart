        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: Icon(
              Icons.email,
              color:
                  _focusNode1.hasFocus ? Colors.lightGreen : Colors.grey[600],
            ),
            contentPadding:
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: Icon(
              Icons.email,
              color:
                  _focusNode4.hasFocus ? Colors.lightGreen : Colors.grey[600],
            ),
            contentPadding:
                EdgeInsets.symmetric(horizontal: 15.w, vertical: 15.h),
            enabledBorder: OutlineInputBorder(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: Icon(
              Icons.key,
              color:
                  _focusNode2.hasFocus ? Colors.lightGreen : Colors.grey[600],
            ),
            contentPadding:
                EdgeInsets.symmetric(horizontal: 15.w, vertical: 15.h),
            enabledBorder: OutlineInputBorder(
